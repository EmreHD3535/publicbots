...
module.exports.run = async (bot, message, args) => { 
  ...
  var embed2 = new Discord.RichEmbed()   
      ...
      .setDescription('sadece sahibim bu komutu  kullanabilir! Yani MercurianBey ﾃ#0001 ')
      .setColor('RED') 
  

  if(message.author.id !== "285381019106803712") return message.channel.sendEmbed(embed2)
     
  //Cortex botun reboot sistemi hadi h.o
  var embed = new Discord.RichEmbed()   
      .setTitle('**Merhaba Sahibim ⺈ᴍᴇʀᴄᴜʀɪᴀɴʙᴇʏﾃ#6666,**')
