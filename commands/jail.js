...
if(!sebep) sebep = 'Sebep belirtilmemiş.'
  ...
  .setColor(`#f3c7e1`)
  .setDescription(`Birisi Karantinaya Atıldı!.`)
  .addField(`**<a:dansedenkopke:750769978629685258>Karantinaya yollanan kişi<a:dansedenkopke:750769978629685258>:**`, kişi, true)
  .addField(`**<a:kayiticin:750767393558626475>  Gönderen Yetkili<a:kayiticin:750767393558626475>  **`, `<@${message.author.id}>`, true)
  .addField(`**<:poncikkalpli:727382065582178386> Sebep:<:poncikkalpli:727382065582178386> **`, sebep, true)
  .addField(`**<a:kral:727382115964026880> Süre:<a:kral:727382115964026880> **`, zaman.replace(/d/, ' gün').replace(/s/, ' saniye').replace(/m/, ' dakika').replace(/h/, ' saat'), true)
  .setTimestamp()
  ...
  .addField(`**<a:cat:744320597101641818> Çıkan Kişi<a:cat:744320597101641818> **`, kişi, true)
  .addField(`<:dadidadi:725408243618283691> **Gönderen Yetkili: <:dadidadi:725408243618283691> **`, `<@${message.author.id}>`, true)
  .setTimestamp()
  .setColor(`#f3c7e1`)
